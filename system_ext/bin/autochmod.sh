...
function transferSystemAppLog(){
    ...
    #OBRAIN
    OBRAIN_LOG=/sdcard/Android/data/com.oplus.obrain/files/xlog
...
function collectWifiConnectLog() {
    ...
    wifiConnectLogPath="${DATA_DEBUGGING_PATH}/wifi_connect_log"
...
function packWifiConnectLog() {
    wifiConnectLogPath="${DATA_DEBUGGING_PATH}/wifi_connect_log"
    DCS_WIFI_LOG_PATH="${DATA_OPLUS_LOG_PATH}/DCS/de/network_logs/wifi"
...
function recover_hang() {
 sleep 30
 boot_completed=`getprop sys.oplus.boot_completed`
